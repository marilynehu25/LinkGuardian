...
@authentification.route("/add_user", methods=["POST"])
@login_required
def add_user():
...
@authentification.route("/edit_user/<int:user_id>", methods=["POST"])
@login_required
...
@authentification.route("/delete_user/<int:user_id>", methods=["POST"])
@login_required
